...
import { Loader2, Video, Film, Clock, Play } from 'lucide-react';
    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Generate professional video ad scripts with scene-by-scene breakdowns.</p>
        </div>
